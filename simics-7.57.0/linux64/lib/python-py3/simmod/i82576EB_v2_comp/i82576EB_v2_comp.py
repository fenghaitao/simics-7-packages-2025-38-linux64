...
class i82576EB_v2_comp(x86_bios_old_comp):
    ...
    def setup(self):
        ...
        if not self.instantiated.val:
            self.add_i82576eb_objects()
        self.add_i82576eb_connectors()
    ...
    def add_i82576eb_connectors(self):
    ...
    def add_i82576eb_objects(self):
        mac = self.add_pre_obj('mac[2]', 'i82576EB_v2')
        ...
        for i in range(len(mac)):
            ...
            phy[i].mac  = mac[i]
            phy[i].registers = [0, 0, 0x02A8, 0x0390] + [0] * 28
            phy[i].tx_bandwidth = 1000000000 # 1Gb/s
            phy[i].address = i
