...
# Define instantiation function for device i82571EB_v2
def Instantiate_i82571EB_v2(tb):
    # i82571 GbE MAC controller
    lan = simics.pre_conf_object('lan', 'i82571EB_v2')
