...
testbench = test_bench.TestBench(#bp_mask         = 0x7,
                                 ...
                                 sector_number   = 32,
                                 elec_signature  = 0x14,
                                 JEDEC_signature = [0x20, 0x20, 0x15])
...
testbench.test_sector_protection(2, 30)
testbench.test_program_protection(0, 32)
testbench.test_program_protection(1, 31)
testbench.test_program_protection(2, 30)
testbench.test_program_protection(3, 28)
testbench.test_program_protection(4, 24)
testbench.test_program_protection(5, 16)
