...
testbench.test_program_protection(0, 16)
testbench.test_program_protection(1, 15)
testbench.test_program_protection(2, 14)
testbench.test_program_protection(3, 12)
...
testbench.test_sector_protection(3, 12)
