...
import stest
import info_status
import sample_802_15_4_transceiver_common

# Verify that info/status commands have been registered for all
# classes in this module.
info_status.check_for_info_status(['sample-802-15-4-transceiver'])

# Create an instance of each object defined in this module
dev = sample_802_15_4_transceiver_common.create_sample_802_15_4_transceiver()
