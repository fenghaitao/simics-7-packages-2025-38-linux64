...
# Define instantiation function for device i82576eb_v2
def Instantiate_i82576EB_v2(tb):
    # i82574 GbE MAC controller
    lan = simics.pre_conf_object('lan', 'i82576EB_v2')
...
tb = TestBench(Instantiate_i82576EB_v2)
