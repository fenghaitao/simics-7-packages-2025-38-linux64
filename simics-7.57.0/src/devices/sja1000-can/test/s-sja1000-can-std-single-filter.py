...
cli.run_command("mems1.write address = 18 size = 1 value = 0x55 -l") #acr2
cli.run_command("mems1.write address = 19 size = 1 value = 0x66 -l") #acr3
...
cli.run_command("mems1.write address = 22 size = 1 value = 0xff -l") #amr2
cli.run_command("mems1.write address = 23 size = 1 value = 0xff -l") #amr3
#set to single filter and go into operation mode
cli.run_command("mems1.write address = 0 size = 1 value = 0x08 -l")
