...
#ifndef CPP_API_EXTENSIONS_SRC_SME_PATTERN_RULES_FALLING_BIT_H
#define CPP_API_EXTENSIONS_SRC_SME_PATTERN_RULES_FALLING_BIT_H
...
namespace sme {
    ...
    namespace rules {
        ...
        /**
         * @brief rule specifically to monitor a single bit for falling edge.
         * 
         */
        class falling_bit : public I_no_params_pattern_rule
        {
        public:
            /**
            ...
            /**
             * @brief Destroy the falling bit object.
             * 
             */
            virtual ~falling_bit()	{;}
...
#endif /*NOTIFICATION_RULE_FALLING_BIT_H_*/
