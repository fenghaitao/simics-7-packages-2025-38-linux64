...
class reset_signal_mock(pyobj.ConfObject):
...
SIM_create_object("reset_signal_mock", "reset_signal_mock", [])
SIM_create_object("cf9_handler", "cf9",
                  [["reset_signal", conf.reset_signal_mock]])
SIM_run_command('log-level 4')
reg = dev_util.Register_LE(conf.cf9.bank.regs, 0, 1)
