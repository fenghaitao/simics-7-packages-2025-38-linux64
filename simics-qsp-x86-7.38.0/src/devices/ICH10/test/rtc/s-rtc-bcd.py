...
# s-rtc-bcd.py
# test the BCD and binary format of the real-time clock
...
# 2009-7-17:12:12:12, Friday
do_test("bcd", sec=0x12, min=0x12, hour=0x12, dow=4, dom=0x17, month=7, year=9)

# 2009-7-17:12:12:13, Friday
do_test("binary", sec=13, min=12, hour=12, dow=4, dom=17, month=7, year=9)
