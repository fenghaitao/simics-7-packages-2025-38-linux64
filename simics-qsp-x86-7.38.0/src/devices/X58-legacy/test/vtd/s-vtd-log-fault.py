...
# s-vtd-log-fault.py
# tests primary and advanced way of logging fault in the Intel (r) VT-d hardware

from vtd_tb import *

fr_size        = VTdConst._fault_record_size
